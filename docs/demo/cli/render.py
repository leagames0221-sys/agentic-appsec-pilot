...
def main() -> int:
    targets = [
        ("help.txt", "agentic-appsec --help", 28),
        ("scan.txt", "cat docs/demo/sample-scan.sarif    # SARIF 2.1.0 output of scan tests/ir/fixtures", 24),
        ("threat-model.txt", "agentic-appsec threat-model . --app-type 'Agentic AI application' --provider mock", 24),
    ]
