/**
 * OWASP Top 10 for LLM Applications 2025 (LLM01-LLM10) → STRIDE mapping
 *
 * Adapted from STRIDE-GPT threat_model.py::create_llm_stride_prompt_section()
...
export function owaspLlmStridePromptSection(): string {
  return `
