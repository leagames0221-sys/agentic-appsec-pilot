/**
 * OWASP Top 10 for Agentic Applications (ASI01-ASI10) → STRIDE mapping
 *
 * Adapted from STRIDE-GPT threat_model.py::create_agentic_stride_prompt_section()
...
export function owaspAsiStridePromptSection(): string {
  return `
